...
#use make to parse Makefile
# USE_NINJA := false
#
# Disable CMSDK
# TARGET_DISABLE_CMSDK := true
#
# Custom Kernel Headers Path
# TARGET_SPECIFIC_HEADER_PATH += $(CANCRO_PATH)/include
#
# Fixed Jack Out Of Memory
# ANDROID_JACK_VM_ARGS := -Dfile.encoding=UTF-8 -XX:+TieredCompilation -Xmx1024M -Xms512M
